  ...
  const weekData: WeekDataRecord[] = [
    {
      key: "1",
      name: "张三",
      monday: { task: 2, blocked: false, overdue: true },
      tuesday: { task: 3, blocked: true, overdue: false },
      wednesday: { task: 1, blocked: false, overdue: true },
      thursday: { task: 4, blocked: false, overdue: false },
      friday: { task: 5, blocked: false, overdue: false },
      saturday: { task: 0, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
      weekTotal: 15,
    },
    {
      key: "2",
      name: "李四",
      monday: { task: 1, blocked: false, overdue: false },
      tuesday: { task: 2, blocked: true, overdue: false },
      wednesday: { task: 3, blocked: false, overdue: false },
      thursday: { task: 0, blocked: false, overdue: false },
      friday: { task: 2, blocked: false, overdue: false },
      saturday: { task: 0, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
      weekTotal: 8,
    },
    {
      key: "3",
      name: "王五",
      monday: { task: 0, blocked: false, overdue: false },
      tuesday: { task: 1, blocked: false, overdue: false },
      wednesday: { task: 0, blocked: false, overdue: false },
      thursday: { task: 1, blocked: false, overdue: false },
      friday: { task: 0, blocked: false, overdue: false },
      saturday: { task: 0, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
      weekTotal: 2,
    },
    {
      key: "4",
      name: "赵六",
      monday: { task: 3, blocked: false, overdue: false },
      tuesday: { task: 2, blocked: false, overdue: false },
      wednesday: { task: 4, blocked: true, overdue: true },
      thursday: { task: 2, blocked: false, overdue: false },
      friday: { task: 3, blocked: false, overdue: false },
      saturday: { task: 1, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
      weekTotal: 15,
    },
    {
      ...
      name: "小明",
      monday: { task: 1, blocked: false, overdue: false },
      tuesday: { task: 0, blocked: false, overdue: false },
      wednesday: { task: 2, blocked: false, overdue: false },
      thursday: { task: 1, blocked: false, overdue: false },
      friday: { task: 0, blocked: false, overdue: false },
      saturday: { task: 0, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
    ...
    },
    {
      key: "6",
      name: "小红",
      monday: { task: 2, blocked: false, overdue: false },
      tuesday: { task: 2, blocked: false, overdue: false },
      wednesday: { task: 2, blocked: true, overdue: false },
      thursday: { task: 2, blocked: false, overdue: false },
      friday: { task: 2, blocked: false, overdue: false },
      saturday: { task: 0, blocked: false, overdue: false },
      sunday: { task: 0, blocked: false, overdue: false },
